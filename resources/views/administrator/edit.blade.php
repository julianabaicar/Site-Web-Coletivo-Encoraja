...
<div>
    <form class="row g-3" action="/adm/{{ $user->id }}" method="POST">
        ...
        <div class="col-md-6">
            ...
            <input type="cpf" class="form-control" id="cpf" name="cpf" value="{{ $user->cpf }}">
        </div>
        <div class="col-md-6">
        ...
        @foreach($user->addresses as $address)
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="neighbourhood" name="neighbourhood" value="{{ $address->neighbourhood }}">
            </div>
            <div class="col-md-6">
        ...
        @endforeach
        <div>
            <input type="checkbox" id="image_term" name="image_term"  value="{{ $user->image_term }}">
            <label for="image_term">Aceito termo de imagem</label>
        </div>
        <div>
            <input type="checkbox" id="data_term" name="data_term"  value="{{ $user->data_term }}">
