...
class Address{
    ...
    public function registerAddress(string $street, int $number, string $neighborhoods, string $city, int $zip_code)
    {
        $this->street = $street;
        $this->number = $number;
    ...
    public function changeAddress(string $street, int $number, string $neighborhoods, string $city, int $zip_code)
    {
        $this->street = $street;
        $this->number = $number;
        $this->neighborhoods = $neighborhoods;
